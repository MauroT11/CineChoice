              ...
              {movies.map((movie) => (
                <div key={movie.id} 
                  ...
                  <div className="card-body p-4">
                    <h2 className="card-title text-xl md:text-2xl tracking-wide font-bold mb-3">{movie.title}</h2>
                    ...
                    <div className="card-actions justify-center mt-4">
                      ...
                      <dialog id={`my_modal_${movie.id}`} className="modal">
                        <div className="modal-box bg-base-100">
                          <h3 className="font-bold text-xl mb-3 text-primary">{movie.title}</h3>
                          <p className="py-4 text-primary/90">{movie.overview}</p>
