...
export default function MovieTopRatedTablet({movies, Genre, Genres}) {
    ...
    return (
        <div className="flex flex-col items-center min-h-full">
            {Genres ? (
                <select className="my-4 border-2 border-secondary rounded-lg text-2xl text-center" onChange={handleGenre}>
            ...
            <div className="grid mx-1 grid-cols-3 gap-2">
              {movies.map((movie) => (
